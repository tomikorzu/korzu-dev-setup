...
export default function LanguageProvider({
  ...
  const [language, setLanguage] = useState<Language>(userLanguage === "ES" ? Language.ES : Language.EN);
  ...
  return (
    <LanguageContext.Provider value={{ language, toggleLanguage, isHydrated, setLanguage }}>
      {children}
