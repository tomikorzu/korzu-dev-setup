 ...
 */
function getLineFlex(
  position: NonNullable<DividerProps["labelPosition"]>,
): [number, number] {
  switch (position) {
    case "left":
      return [0.15, 1];
...
export default function Divider({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: this variant renders a label as a child — <hr> can't have children
    <Box
      role="separator"
      aria-orientation="horizontal"
      sx={{
